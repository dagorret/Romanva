"""
Django settings for Romanova Platform
"""
...
DATABASES = {
    'default': {
        ...
        'USER': config('DB_USER', default='msp_user'),
        'PASSWORD': config('DB_PASSWORD', default='msp_password_2024'),
...
# Session settings
SESSION_COOKIE_NAME = 'msp_sessionid'
